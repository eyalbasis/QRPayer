...
namespace QRPayer.Migrations.NorthwindDB
{
    ...
    public class DefaultDB_20141123_155100_Initial : Migration
    {
        public override void Up()
        {
            IfDatabase("SqlServer", "SqlServer2000", "SqlServerCe")
                .Execute.EmbeddedScript("QRPayer.Migrations.NorthwindDB.NorthwindDBScript_SqlServer.sql");

            IfDatabase("Postgres")
                .Execute.EmbeddedScript("QRPayer.Migrations.NorthwindDB.NorthwindDBScript_Postgres.sql");

            IfDatabase("Postgres")
                .Execute.EmbeddedScript("QRPayer.Migrations.NorthwindDB.NorthwindDBScript_PostgresData.sql");

            IfDatabase("MySql")
                .Execute.EmbeddedScript("QRPayer.Migrations.NorthwindDB.NorthwindDBScript_MySql.sql");

            IfDatabase("Oracle")
                .Execute.EmbeddedScript("QRPayer.Migrations.NorthwindDB.NorthwindDBScript_Oracle.sql");

            IfDatabase("Sqlite")
                .Execute.EmbeddedScript("QRPayer.Migrations.NorthwindDB.NorthwindDBScript_Sqlite.sql");
