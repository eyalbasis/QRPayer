...
(function (QRPayer) {
    ...
    })(Administration = QRPayer.Administration || (QRPayer.Administration = {}));
})(QRPayer || (QRPayer = {}));
var QRPayer;
(function (QRPayer) {
    var Administration;
...
(function (QRPayer) {
    ...
    })(BasicSamples = QRPayer.BasicSamples || (QRPayer.BasicSamples = {}));
})(QRPayer || (QRPayer = {}));
var QRPayer;
(function (QRPayer) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = QRPayer.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = QRPayer.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = QRPayer.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (QRPayer) {
    ...
    })(Common = QRPayer.Common || (QRPayer.Common = {}));
})(QRPayer || (QRPayer = {}));
var QRPayer;
(function (QRPayer) {
    var Common;
...
(function (QRPayer) {
    ...
    (function (Default) {
        ...
        [,
            ...
            ['Places', function () { return Serenity.IntegerEditor; }],
            ['Accessible', function () { return Serenity.BooleanEditor; }]
        ].forEach(function (x) { return Object.defineProperty(CustomerTablesForm.prototype, x[0], {
            get: function () {
    ...
    })(Default = QRPayer.Default || (QRPayer.Default = {}));
})(QRPayer || (QRPayer = {}));
var QRPayer;
(function (QRPayer) {
    var Default;
    (function (Default) {
        ...
        (function (CustomerTablesRow) {
            ...
            var Fields;
            (function (Fields) {
            })(Fields = CustomerTablesRow.Fields || (CustomerTablesRow.Fields = {}));
            [
                'Id',
                'Number',
                'Places',
...
(function (QRPayer) {
    ...
    (function (Default) {
        ...
        (function (CustomerTablesService) {
            ...
            var Methods;
            (function (Methods) {
            })(Methods = CustomerTablesService.Methods || (CustomerTablesService.Methods = {}));
            [
                'Create',
                'Update',
                'Delete',
                ...
                Methods[x] = CustomerTablesService.baseUrl + '/' + x;
            });
...
(function (QRPayer) {
    ...
    (function (Default) {
        ...
        [
            ['ClubMember', function () { return Serenity.StringEditor; }],
            ['PersonId', function () { return Serenity.IntegerEditor; }]
        ].forEach(function (x) { return Object.defineProperty(CustomersForm.prototype, x[0], {
            get: function () {
                return this.w(x[0], x[1]());
            },
            enumerable: true,
...
(function (QRPayer) {
    ...
    (function (Default) {
        ...
        ].forEach(function (x) { return Object.defineProperty(ItemsForm.prototype, x[0], {
            get: function () {
                return this.w(x[0], x[1]());
            },
            enumerable: true,
...
(function (QRPayer) {
    ...
    (function (Default) {
        ...
        (function (ItemsRow) {
            ...
            var Fields;
            (function (Fields) {
            })(Fields = ItemsRow.Fields || (ItemsRow.Fields = {}));
            [
                'Name',
                'Price',
                'Id'
...
(function (QRPayer) {
    ...
    (function (Default) {
        ...
        (function (ItemsService) {
            ...
            var Methods;
            (function (Methods) {
            })(Methods = ItemsService.Methods || (ItemsService.Methods = {}));
            [
                'Create',
                'Update',
                'Delete',
                ...
                Methods[x] = ItemsService.baseUrl + '/' + x;
            });
...
(function (QRPayer) {
    ...
    (function (Default) {
        ...
        [
            ['Body', function () { return Serenity.StringEditor; }],
            ['Subject', function () { return Serenity.StringEditor; }],
            ['CustomerId', function () { return Serenity.IntegerEditor; }]
        ].forEach(function (x) { return Object.defineProperty(MailsMessagesForm.prototype, x[0], {
            get: function () {
                return this.w(x[0], x[1]());
            },
            enumerable: true,
...
(function (QRPayer) {
    ...
    (function (Default) {
        ...
        (function (MailsMessagesRow) {
            ...
            var Fields;
            (function (Fields) {
            })(Fields = MailsMessagesRow.Fields || (MailsMessagesRow.Fields = {}));
            [
                'Body',
                'Subject',
                'Id',
...
(function (QRPayer) {
    ...
    (function (Default) {
        ...
        (function (MailsMessagesService) {
            ...
            var Methods;
            (function (Methods) {
            })(Methods = MailsMessagesService.Methods || (MailsMessagesService.Methods = {}));
            [
                'Create',
                'Update',
                'Delete',
                ...
                Methods[x] = MailsMessagesService.baseUrl + '/' + x;
            });
...
(function (QRPayer) {
    ...
    (function (Default) {
        ...
        ].forEach(function (x) { return Object.defineProperty(PersonsForm.prototype, x[0], {
            get: function () {
                return this.w(x[0], x[1]());
            },
            enumerable: true,
...
(function (QRPayer) {
    ...
    (function (Default) {
        ...
        (function (PersonsRow) {
            ...
            var Fields;
            (function (Fields) {
            })(Fields = PersonsRow.Fields || (PersonsRow.Fields = {}));
            [
                'Name',
                'Birthday',
                'Phone',
...
(function (QRPayer) {
    ...
    (function (Default) {
        ...
        (function (PersonsService) {
            ...
            var Methods;
            (function (Methods) {
            })(Methods = PersonsService.Methods || (PersonsService.Methods = {}));
            [
                'Create',
                'Update',
                'Delete',
                ...
                Methods[x] = PersonsService.baseUrl + '/' + x;
            });
...
(function (QRPayer) {
    ...
    (function (Default) {
        ...
        [,
            ...
            ['WaiterId', function () { return Serenity.IntegerEditor; }],
            ['Value', function () { return Serenity.DecimalEditor; }]
        ].forEach(function (x) { return Object.defineProperty(TipsForm.prototype, x[0], {
            get: function () {
                return this.w(x[0], x[1]());
            },
            enumerable: true,
...
(function (QRPayer) {
    ...
    (function (Default) {
        ...
        (function (TipsRow) {
            ...
            var Fields;
            (function (Fields) {
            })(Fields = TipsRow.Fields || (TipsRow.Fields = {}));
            [
                'Id',
                'Date',
                'WaiterId',
...
(function (QRPayer) {
    ...
    (function (Default) {
        ...
        (function (TipsService) {
            ...
            var Methods;
            (function (Methods) {
            })(Methods = TipsService.Methods || (TipsService.Methods = {}));
            [
                'Create',
                'Update',
                'Delete',
                ...
                Methods[x] = TipsService.baseUrl + '/' + x;
            });
...
(function (QRPayer) {
    ...
    (function (Default) {
        ...
        [,
            ['TransactionId', function () { return Serenity.IntegerEditor; }],
            ['ItemId', function () { return Serenity.IntegerEditor; }],
            ['CustomerId', function () { return Serenity.IntegerEditor; }],
            ['TotalPaid', function () { return Serenity.DecimalEditor; }]
        ].forEach(function (x) { return Object.defineProperty(TransactionItemsForm.prototype, x[0], {
            get: function () {
                return this.w(x[0], x[1]());
            },
            enumerable: true,
...
(function (QRPayer) {
    ...
    (function (Default) {
        ...
        (function (TransactionItemsRow) {
            ...
            var Fields;
            (function (Fields) {
            })(Fields = TransactionItemsRow.Fields || (TransactionItemsRow.Fields = {}));
            [
                'Id',
                'TransactionId',
                'ItemId',
...
(function (QRPayer) {
    ...
    (function (Default) {
        ...
        (function (TransactionItemsService) {
            ...
            var Methods;
            (function (Methods) {
            })(Methods = TransactionItemsService.Methods || (TransactionItemsService.Methods = {}));
            [
                'Create',
                'Update',
                'Delete',
                ...
                Methods[x] = TransactionItemsService.baseUrl + '/' + x;
            });
...
(function (QRPayer) {
    ...
    (function (Default) {
        ...
        [
            ['CustomerTableId', function () { return Serenity.IntegerEditor; }],
            ['NoOfCustomers', function () { return Serenity.IntegerEditor; }],
            ['QrCode', function () { return Serenity.StringEditor; }],
            ['DealNum', function () { return Serenity.StringEditor; }],
            ['WaiterId', function () { return Serenity.IntegerEditor; }],
            ['ItemId', function () { return Serenity.IntegerEditor; }],
            ['Created', function () { return Serenity.DateEditor; }],
            ['Closed', function () { return Serenity.DateEditor; }]
        ].forEach(function (x) { return Object.defineProperty(TransactionsForm.prototype, x[0], {
            get: function () {
                return this.w(x[0], x[1]());
            },
            enumerable: true,
...
(function (QRPayer) {
    ...
    (function (Default) {
        ...
        (function (TransactionsRow) {
            ...
            var Fields;
            (function (Fields) {
            })(Fields = TransactionsRow.Fields || (TransactionsRow.Fields = {}));
            [
                'CustomerTableId',
                'NoOfCustomers',
                'QrCode',
...
(function (QRPayer) {
    ...
    (function (Default) {
        ...
        (function (TransactionsService) {
            ...
            var Methods;
            (function (Methods) {
            })(Methods = TransactionsService.Methods || (TransactionsService.Methods = {}));
            [
                'Create',
                'Update',
                'Delete',
                ...
                Methods[x] = TransactionsService.baseUrl + '/' + x;
            });
...
(function (QRPayer) {
    ...
    (function (Default) {
        ...
        [
            ...
            ['PersonId', function () { return Serenity.IntegerEditor; }]
        ].forEach(function (x) { return Object.defineProperty(WaitersForm.prototype, x[0], {
            get: function () {
                return this.w(x[0], x[1]());
            },
            enumerable: true,
...
(function (QRPayer) {
    ...
    (function (Default) {
        ...
        (function (WaitersRow) {
            ...
            var Fields;
            (function (Fields) {
            })(Fields = WaitersRow.Fields || (WaitersRow.Fields = {}));
            [
                'UserId',
                'Id',
                'PersonId',
...
(function (QRPayer) {
    ...
    (function (Default) {
        ...
        (function (WaitersService) {
            ...
            var Methods;
            (function (Methods) {
            })(Methods = WaitersService.Methods || (WaitersService.Methods = {}));
            [
                'Create',
                'Update',
                'Delete',
                ...
                Methods[x] = WaitersService.baseUrl + '/' + x;
            });
...
(function (QRPayer) {
    ...
    })(Membership = QRPayer.Membership || (QRPayer.Membership = {}));
})(QRPayer || (QRPayer = {}));
var QRPayer;
(function (QRPayer) {
    var Membership;
...
(function (QRPayer) {
    ...
    })(Northwind = QRPayer.Northwind || (QRPayer.Northwind = {}));
})(QRPayer || (QRPayer = {}));
var QRPayer;
(function (QRPayer) {
    var Northwind;
...
(function (QRPayer) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'QRPayer.Northwind.Gender', 'QRPayer.Northwind.Entities.Gender');
    })(Northwind = QRPayer.Northwind || (QRPayer.Northwind = {}));
})(QRPayer || (QRPayer = {}));
var QRPayer;
(function (QRPayer) {
...
(function (QRPayer) {
    ...
    })(Authorization = QRPayer.Authorization || (QRPayer.Authorization = {}));
})(QRPayer || (QRPayer = {}));
var QRPayer;
(function (QRPayer) {
    var Administration;
...
(function (QRPayer) {
    ...
    (function (BasicSamples) {
        ...
        }(QRPayer.Northwind.ProductDialog));
    ...
    (function (Northwind) {
        var ProductGrid = /** @class */ (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(QRPayer.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(QRPayer.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        QRPayer.Common.ReportHelper.execute({
        ...
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: QRPayer.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: QRPayer.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new QRPayer.Northwind.OrderDialog();
                        ...
                        var chai = QRPayer.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = QRPayer.Northwind.EmployeeRow.getLookup().items
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(QRPayer.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
...
(function (QRPayer) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    QRPayer.Northwind.CategoryService.Retrieve({
        ...
        }(QRPayer.Northwind.CategoryDialog));
...
(function (QRPayer) {
    ...
    (function (BasicSamples) {
        ...
        }(QRPayer.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(QRPayer.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new QRPayer.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                QRPayer.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(QRPayer.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    QRPayer.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(QRPayer.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(QRPayer.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    QRPayer.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return QRPayer.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return QRPayer.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return QRPayer.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return QRPayer.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var SupplierDialog = /** @class */ (function (_super) {
            ...
            SupplierDialog.prototype.getLanguages = function () {
                return QRPayer.LanguageList.getValue();
            };
...
(function (QRPayer) {
    ...
    (function (BasicSamples) {
        ...
        }(QRPayer.Northwind.SupplierDialog));
...
(function (QRPayer) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(QRPayer.Northwind.SupplierGrid));
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                QRPayer.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
...
(function (QRPayer) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    QRPayer.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(QRPayer.Northwind.CustomerDialog));
...
(function (QRPayer) {
    ...
    (function (BasicSamples) {
        ...
        }(QRPayer.Northwind.CustomerGrid));
...
(function (QRPayer) {
    ...
    (function (BasicSamples) {
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = QRPayer.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return QRPayer.Northwind.OrderDetailRow.localTextPrefix; };
        ...
        }(QRPayer.Common.GridEditorDialog));
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return QRPayer.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new QRPayer.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(QRPayer.Northwind.OrderDetailDialog));
...
(function (QRPayer) {
    ...
    (function (BasicSamples) {
        ...
        }(QRPayer.Northwind.OrderDetailsEditor));
...
(function (QRPayer) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return QRPayer.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return QRPayer.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return QRPayer.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return QRPayer.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return QRPayer.Northwind.CategoryRow.lookupKey;
            };
            /**
    ...
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new QRPayer.BasicProgressDialog();
...
(function (QRPayer) {
    ...
    (function (BasicSamples) {
        ...
        }(QRPayer.Common.BulkServiceAction));
...
(function (QRPayer) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return QRPayer.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return QRPayer.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return QRPayer.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return QRPayer.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(QRPayer.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new QRPayer.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new QRPayer.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new QRPayer.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (QRPayer) {
    ...
    QRPayer.SelectableEntityGrid = SelectableEntityGrid;
})(QRPayer || (QRPayer = {}));
...
(function (QRPayer) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return QRPayer.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return QRPayer.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return QRPayer.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return QRPayer.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(QRPayer.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = QRPayer.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            QRPayer.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (QRPayer) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return QRPayer.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return QRPayer.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return QRPayer.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return QRPayer.Northwind.ProductService.baseUrl; };
...
(function (QRPayer) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return QRPayer.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return QRPayer.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return QRPayer.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return QRPayer.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (QRPayer) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return QRPayer.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return QRPayer.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (QRPayer) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return QRPayer.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return QRPayer.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return QRPayer.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
(function (QRPayer) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = QRPayer.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = QRPayer.LanguageList || (QRPayer.LanguageList = {}));
})(QRPayer || (QRPayer = {}));
...
(function (QRPayer) {
    ...
    (function (ScriptInitialization) {
        ...
        Serenity.EntityDialog.defaultLanguageList = QRPayer.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = QRPayer.ScriptInitialization || (QRPayer.ScriptInitialization = {}));
})(QRPayer || (QRPayer = {}));
var QRPayer;
(function (QRPayer) {
    ...
    QRPayer.BasicProgressDialog = BasicProgressDialog;
})(QRPayer || (QRPayer = {}));
var QRPayer;
(function (QRPayer) {
    var DialogUtils;
    ...
    })(DialogUtils = QRPayer.DialogUtils || (QRPayer.DialogUtils = {}));
})(QRPayer || (QRPayer = {}));
var QRPayer;
(function (QRPayer) {
    var Common;
...
(function (QRPayer) {
    ...
    QRPayer.StaticTextBlock = StaticTextBlock;
})(QRPayer || (QRPayer = {}));
var QRPayer;
(function (QRPayer) {
    var Common;
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: QRPayer.Authorization.userDefinition.DisplayName,
...
//# sourceMappingURL=QRPayer.Web.js.map